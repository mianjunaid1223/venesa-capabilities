...
module.exports = {
  ...
  name: "getDiskInfo",
  description:
    "Shows lala all fixed drives (C:, D:, etc.) with total size, free space in GB, and usage percentage. Use when the user asks about disk space, storage capacity, how full a drive is, or whether they have enough space.",
